            ...
            <div style={{ display: "flex", justifyContent: "center",marginTop:"3%" }}>
                        ...
                        <Carousel dotPosition="bottom" autoplay>
                            <div>
                                <div className="change-photos" style={{ padding: "3%" }} >
                                    ...
                                    <div className="change-photo" style={{ marginTop: "30%", marginLeft: "35%", backgroundColor: "#f2efee", textAlign: "center" }}>
                                        <div>
                                            <p style={{ fontSize: "20px" }}><b>Acqua Di Gio</b></p>
                            ...
                            <div>
                                <div className="change-photos" style={{ padding: "3%" }} >
                                    ...
                                    <div className="change-photo" style={{ marginTop: "30%", marginLeft: "35%", backgroundColor: "#f2efee", textAlign: "center" }}>
                                        <div>
                                            <p style={{ fontSize: "20px" }}><b>Armani Beauty</b></p>
                            ...
                            <div>
                                <div className="change-photos" style={{ padding: "3%" }} >
                                    ...
                                    <div className="change-photo" style={{ marginTop: "30%", marginLeft: "35%", backgroundColor: "#f2efee", textAlign: "center" }}>
                                        <div>
                                            <p style={{ fontSize: "20px" }}><b>B   urberry Brit </b></p>
                ...
                <div>
                    ...
                    <div style={{ display: "flex", justifyContent: "center" }}>
                        <div className="change-photos" style={{ padding: "3%" }} >
                            <div className="change-photo">
                                <img src="https://darko-theme.myshopify.com/cdn/shop/products/Darko_01_600x.png?v=1630990658" height="200px" width="200px" className="img-1" />
                            </div>
                            <div className="change-photo" style={{ marginTop: "20%", marginLeft: "15%", backgroundColor: "#f2efee", textAlign: "center" }}>
                                <div>
                        ...
                        <div className="change-photos" style={{ padding: "3%" }} >
                            <div className="change-photo">
                                <img src="https://darko-theme.myshopify.com/cdn/shop/products/Darko_02_cda074e1-0599-4dd6-822f-65a9037a590b_600x.png?v=1603430384" height="200px" width="200px" className="img-1" />
                            </div>
                            <div className="change-photo" style={{ marginTop: "20%", marginLeft: "15%", backgroundColor: "#f2efee", textAlign: "center" }}>
                                <div>
                                    <p style={{ fontSize: "20px" }}><b>Carala Gio</b></p>
                    ...
                    <button className="number2" style={{cursor:"pointer" }} onClick={() => navigate('/page')}>2</button>
